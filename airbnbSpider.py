...
def getAirbnb(locate, offset=0):
    ...
    url = "https://www.airbnb.cn/api/v2/explore_tabs?_format=for_explore_search_web&auto_ib=true&client_session_id=3ae72c67-94f2-4a32-a775-4f906ce7d13e&currency=CNY&experiences_per_grid=20&fetch_filters=true&guidebooks_per_grid=50&has_zero_guest_treatment=true&hide_dates_and_guests_filters=false&is_guided_search=true&is_new_cards_experiment=true&is_standard_search=true&items_per_grid=50&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&locale=zh&map_toggle=true&metadata_only=false&query=" + \
        str(locate)
    url = url.strip()
    time.sleep(0.1)
    if not offset == 0:
