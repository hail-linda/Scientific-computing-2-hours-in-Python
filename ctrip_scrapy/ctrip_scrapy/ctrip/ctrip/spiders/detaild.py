...
class DetialdSpider(BaseSpider):
    name = 'detaild'
    allowed_domains = ['m.ctrip.com']
    redis_key = 'detail:start_urls'

    url = "https://m.ctrip.com/restapi/soa2/16593/getHouse" \
          "?_fxpcqlniredt=09031156211865914676&__gw_appid=99999999" \
          "&__gw_ver=1.0&__gw_from=600003547&__gw_platform=H5"
